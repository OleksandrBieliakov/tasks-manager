...
public class OpenAPIConfig {
    ...
    private final TaskManagerProperties props;
    private final KeycloakSpringBootProperties keycloakProps;

    public OpenAPIConfig(TaskManagerProperties props, KeycloakSpringBootProperties keycloakProps) {
        this.props = props;
    ...
    OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info().title("Task Manager API").version("1"))
